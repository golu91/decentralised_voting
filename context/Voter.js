    ...
    if (file) {
      try {
        ...
        const response = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `c333e98b9158d3476cb9`,
            pinata_secret_api_key: `
a04258fc98888d79dfd853989643469ef9ffb2e152e183176e2f809f22edc3ef`,
  ...
  const getNewCandidate = async () => {
    ...
    for (let i = 0; i < allCandidate.length; i++) {
      try {
        ...
        console.error(`Error fetching data for candidate ${allCandidate[i]}:`, error);
      }
    }
